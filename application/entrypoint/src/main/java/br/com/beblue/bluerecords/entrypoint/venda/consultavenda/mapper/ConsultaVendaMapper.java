package br.com.beblue.bluerecords.entrypoint.venda.consultavenda.mapper;
...
import br.com.beblue.bluerecords.entrypoint.venda.consultavenda.dto.ConsultarVendaItemResponseDTO;
...
public class ConsultaVendaMapper {
    ...
    public static ResponseEntity<ConsultarVendaResponseDTO> vendaToResponseDTO(Venda venda) {
        if (venda == null)
    ...
    private static List<ConsultarVendaItemResponseDTO> converteItemToResponse(List<VendaItem> vendaItems) {
